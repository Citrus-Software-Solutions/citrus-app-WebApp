import { GetOfferService } from '../../src/job/application/services/ConsultAllOffersService'
import { GetOfferAdapter } from '../../src/job/infrastructure/driven-adapters/in/ConsultAllOffersAdapter'
